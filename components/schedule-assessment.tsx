    ...
    <div className="text-white">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-2xl p-12 max-w-sm w-full mx-4 flex flex-col items-center justify-center gap-6">
            <div className="h-16"></div>
            <button
              onClick={() => setShowModal(false)}
              className="bg-[#2d5184] hover:bg-[#1e3c66] text-white px-8 py-2.5 rounded text-sm font-medium transition-all duration-200 hover:shadow-md"
            >
              Close
            </button>
